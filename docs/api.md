...
- [class: ElementHandle](#class-elementhandle)
  ...
  - [elementHandle.isIntersectingViewport(threshold)](#elementhandleisintersectingviewport)
...
#### elementHandle.isIntersectingViewport(threshold)

- `threshold` <[number]> threshold to be allowed
